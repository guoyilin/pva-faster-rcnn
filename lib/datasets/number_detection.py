...
#	self._classes = ('__background__','number_0','number_1','number_2','number_3','number_4','number_5','number_6', 'number_7')
    ...
    def _load_image_set_index(self, imagelist):
        ...
        image_set_file = os.path.join(self._data_path, imagelist+".txt")# load ImageList that only contain ImageFileName
	...
	f = open(filename)
       ...
       # print index
	    ...
	    gt_classes[ix] = int(split_str[0])
            ...
            x2 = float(split_str[3])
            y2 = float(split_str[4])
        #    print self._class_to_ind
            #cls = self._class_to_ind['number_'+class_label]
            cls = gt_classes[ix]
